...
- Prefers HTML over plain-text and markdown for email reports — explicitly switched from .md attachments to inline HTML tables, finding .md "poco legible" (not very readable). Confidence: 0.9
