...
export default function DeleteConfirm({ nombre, onConfirmar, onCancelar }) {
  ...
  const btnBase =
    'font-mono text-lg px-3.5 py-1.5 border rounded-sm tracking-[0.06em] bg-transparent cursor-pointer transition-colors outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1 focus-visible:ring-offset-bg';
  return (
    <div
    ...
    >
      ...
      >
        <div className="px-4.5 py-3.5 border-b border-edge">
          <h2
            id={titleId}
            className="text-lg tracking-[0.12em] uppercase text-ink-mid m-0 font-normal"
          >
        ...
        <div className="px-4.5 py-5 flex flex-col gap-2 text-[14px]">
          <p>
            ¿Eliminar <strong className="text-ink-hi">{nombre}</strong>?
          </p>
          <p id={descId} className="text-ink-dim">
